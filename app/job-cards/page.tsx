    ...
    try {
      ...
      const processedHistory: JobCard[] = allJobCardsData
        ...
        .filter((card: JobCard) => {
          ...
          return numberPart && !isNaN(Number.parseInt(numberPart, 10))
        })
                ...
                <CardContent className="p-0 flex-1 flex flex-col">
                  {pendingOrders.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-10 px-4 text-center flex-1">
                      <FileCheck className="h-12 w-12 text-purple-500 mb-3" />
                                ...
                                >
                                  {column.dataKey === "actionColumn" ? (
                                    <Button
                                      ...
                                      className="text-xs h-7 px-2 py-1 bg-purple-600 text-white hover:bg-purple-700"
                                    >
                                      Create Job Card
                                    </Button>
                                  ) : (
